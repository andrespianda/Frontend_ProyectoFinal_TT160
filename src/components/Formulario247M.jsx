...
function Formulario247M() {
  ...
  const [temporal, setTemporal] = useState({ nombreNeoplasiaMaligna: "" });
  ...
  const Section = ({ title, children }) => (
    <section>
      ...
      <div className="grid grid-cols-4 md:grid-cols-4 gap-4">{children}</div>
    </section>
  );
    ...
    <form onSubmit={handleSubmit} className="p-4 space-y-8">
      ...
      <section className="border border-gray-300 p-4 ">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
          ...
          />
          <label name="fechaNacimiento">
            {datoCa.fechaNacimiento}
            </label>
                      <input
            type='hidden'
          ...
          <label name="sexo">
            ...
            type='hidden'
            name='sexo'
            defaultValue={temporal.sexo}
          />
          <label name="ocupacion">
            {datoCa.ocupacion}
            </label>
                      <input
            type='hidden'
          ...
          />
          <label name="regimenAfiliacionSGSSS">
            {datoCa.regimenAfiliacionSGSSS}
            </label>
                      <input
            type='hidden'
          ...
          />
          <label name="codigoPertenenciaEtnica">
            {datoCa.codigoPertenenciaEtnica}
            </label>
                      <input
            type='hidden'
          ...
          />
          <label name="grupoPoblacional">
            {datoCa.grupoPoblacional}
            </label>
                      <input
            type='hidden'
          ...
          />
          <label name="municipioResidencia">
            {datoCa.municipioResidencia}
            </label>
                      <input
            type='hidden'
          ...
          />
          <label name="telefonoPaciente">
            {datoCa.telefonoPaciente}
            </label>
                      <input
            type='hidden'
          ...
          />
          <label name="fechaAfiliacionEPS">
            {datoCa.fechaAfiliacionEPS}
            </label>
                      <input
            type='hidden'
      ...
      <Section title="Tratamientos sistémicos">
        ...
        <div className="relative mb-4">
          <input
            ...
            defaultValue={datoCa.numeroMedicamentosPropuestosPrimerEsquema}
      ...
      <Section title="Radioterapia">
        ...
        <div className="relative mb-4">
          <input
            type="text"
            id="ubicacionRT"
            defaultValue={datoCa.ubicacionTemporalPrimerEsquemaRadioterapia}
        ...
        <div className="relative mb-4">
          <input
           type="text"
            ...
            defaultValue={datoCa.ubicacionTemporalUltimoEsquemaRadioterapia}
